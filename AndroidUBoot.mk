...
$(INSTALLED_UBOOT_TARGET) : $(UBOOT_CONFIG)
	$(MAKE) -C u-boot CROSS_COMPILE=$(LOCAL_TOOLCHAIN) AP_VERSION=$(BUILD_NUMBER) O=../$(UBOOT_OUT)
	$(MAKE) -C u-boot CROSS_COMPILE=$(LOCAL_TOOLCHAIN) AP_VERSION=$(BUILD_NUMBER) O=../$(UBOOT_OUT) fdl2
	...
	$(MAKE) -C u-boot CROSS_COMPILE=$(LOCAL_TOOLCHAIN) AP_VERSION=$(BUILD_NUMBER) AUTOBOOT_FLAG=true O=../$(UBOOT_OUT)
