...
sp8810gb_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp8810 spreadtrum sc8810

sp6820gb_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp6820gb spreadtrum sc8810

sp6820ga_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp6820ga spreadtrum sc8810
...
nevistd_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 nevistd spreadtrum sc8810
...
sp7710g2_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp7710g2 spreadtrum sc8810

sp7710g2fpga_config : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp7710g2 spreadtrum sc8810

tiger_openphone_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
...
sp7715ea_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp7715ea spreadtrum sc8830

sp7715eatrisim_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp7715eatrisim spreadtrum sc8830

sp7715ga_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp7715ga spreadtrum sc8830

sp7715gatrisim_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp7715gatrisim spreadtrum sc8830

sp7715ga-hvga_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp7715ga spreadtrum sc8830

star2_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 star2 spreadtrum sc8830

corsica_ve_config    : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 corsica_ve spreadtrum sc8830

fame2_config : unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 fame2 spreadtrum sc8830

spx15ga_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 spx15ga spreadtrum sc8830

sp6815ga_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
...
sp8825ea_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp8825ea spreadtrum sc8825

sp8825ea_native_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp8825ea spreadtrum sc8825

sp8825eb_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp8825eb spreadtrum sc8825

sp8825eb_native_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp8825eb spreadtrum sc8825

garda_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 garda spreadtrum sc8825

garda_native_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 garda spreadtrum sc8825
...
sp6825gb_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp6825gb spreadtrum sc8825

sp6825gb_native_config	: unconfig
	@mkdir -p $(obj)include
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 sp6825gb spreadtrum sc8825
