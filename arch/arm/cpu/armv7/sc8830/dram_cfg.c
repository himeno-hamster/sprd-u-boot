...
const lpddr2_timing_t LPDDR2_ACTIMING = 
{
    ...
    2               //tMRR 		unite : tCK
#else
    NS2CLK(3800),   //tREFI     uinte : tCK
    NS2CLK(50),     //tRAS 		unite : tCK    
    NS2CLK(80),		//tRC 		unite : tCK
    NS2CLK(210),    //tRFCab    unite : tCK
    NS2CLK(60),     //tRFCpb    unite : tCK
    NS2CLK(30),     //tRCD      unite : tCK
    NS2CLK(30),     //tRP       unite : tCK
    NS2CLK(30),     //tRRD      unite : tCK
    //NS2CLK(15),     //tWR       unite : tCK
    6,              //tWR       unite : tCK
    3,              //tWTR      unite : tCK
    NS2CLK(20),     //tXP       unite : tCK
    ...
    NS2CLK(80),     //tFAW 		unite : tCK
    NS2CLK(500000), //tDPD 		unite : tCK
    NS2CLK(2000),   //tZQINIT	unite : tCK    
    NS2CLK(360),    //tZQCL		unite : tCK    
    NS2CLK(90),     //tZQCS		unite : tCK    
    NS2CLK(50),     //tZQreset  unite : tCK        
    3,              //tCKE 		unite : tCK     
...
//  {DRAM_LPDDR3,    2,      4,         32,       8,   14, 22,12, NULL},//CL=14(DDR3-2133),CL=13(DDR3-1866),CL=11(DDR3-1600),,CL=9(DDR3-1600),CL=7(DDR3-1066)
  ...
  {DRAM_LPDDR2_2CS_8G_X32,   2,   8,      32,        4,   6,  3, 0, (void *)(&LPDDR2_ACTIMING)},
  {DRAM_LPDDR2_2CS_6G_X32,   2,   8,      32,        4,   6,  3, 0, (void *)(&LPDDR2_ACTIMING)},
  {DRAM_LPDDR2_1CS_8G_X32,   1,   8,      32,        4,   6,  3, 0, (void *)(&LPDDR2_ACTIMING)},  
  {DRAM_LPDDR2_2CS_16G_X32,  2,   8,      32,        4,   6,  3, 0, (void *)(&LPDDR2_ACTIMING)},    
  {DRAM_LPDDR2_2CS_12G_X32,  2,   8,      32,        4,   6,  3, 0, (void *)(&LPDDR2_ACTIMING)}
};
 ...
 **                            PUBLIC Functions
 **---------------------------------------------------------------------------*/
PUBLIC DRAM_INFO* GetCfg(DRAM_TYPE_E dram_type)
{
    uint i=0;
