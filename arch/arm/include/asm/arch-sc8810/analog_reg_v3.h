...
#define   ANA_EFUSE_CTL         (ANA_REG_BASE + 0xe0)
#define   ANA_EFUSE_OUT0        (ANA_REG_BASE + 0xe4)
#define   ANA_DLY_CNT           (ANA_REG_BASE + 0xf0)
...
#define   ANA_DCDC_ARM_CTL0     (ANA_REG_BASE + 0x118)
#define   ANA_DCDC_ARM_CTL1     (ANA_REG_BASE + 0x11c)
#define   ANA_DCDC_ARM_CTL2     (ANA_REG_BASE + 0x120)
#define   ANA_DCDC_ARM_CTL3     (ANA_REG_BASE + 0x124)
...
#define   ANA_AFUSE_CTL         (ANA_REG_BASE + 0x1a0)
#define   ANA_AFUSE_OUT0        (ANA_REG_BASE + 0x1a4)
#define   ANA_AFUSE_OUT1        (ANA_REG_BASE + 0x1a8)
#define   ANA_AFUSE_OUT2        (ANA_REG_BASE + 0x1ac)
