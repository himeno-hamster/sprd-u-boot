...
#define   ANA_APB_CLK_CLR    	(ANA_REG_BASE + 0x04)
#define   ANA_APB_CLK_STS       (ANA_REG_BASE + 0x08)
#define   ANA_RTC_CLK_EN        (ANA_REG_BASE + 0x0C)
#define   ANA_RTC_CLK_CLR       (ANA_REG_BASE + 0x10)
#define   ANA_RTC_CLK_STS       (ANA_REG_BASE + 0x14)
#define   ANA_ARM_RST_EN        (ANA_REG_BASE + 0x18)
#define   ANA_ARM_RST_CLR       (ANA_REG_BASE + 0x1C)
#define   ANA_ARM_RST_STS       (ANA_REG_BASE + 0x20)
#define   ANA_ARCH_EN           (ANA_REG_BASE + 0x24)
#define   ANA_LDO_PD_SET        (ANA_REG_BASE + 0x28)
#define   ANA_LDO_PD_RST        (ANA_REG_BASE + 0x2C)
#define   ANA_LDO_PD_CTL0       (ANA_REG_BASE + 0x30)
#define   ANA_LDO_PD_CTL1       (ANA_REG_BASE + 0x34)
#define   ANA_LDO_VCTL0         (ANA_REG_BASE + 0x38)
#define   ANA_LDO_VCTL1         (ANA_REG_BASE + 0x3C)
#define   ANA_LDO_VCTL2         (ANA_REG_BASE + 0x40)
#define   ANA_LDO_VCTL3         (ANA_REG_BASE + 0x44)
#define   ANA_LDO_VCTL4         (ANA_REG_BASE + 0x48)
#define   ANA_LDO_VCTL5         (ANA_REG_BASE + 0x4c)
#define   ANA_LDO_SLP_CTL0      (ANA_REG_BASE + 0x50)
#define   ANA_LDO_SLP_CTL1      (ANA_REG_BASE + 0x54)
#define   ANA_LDO_SLP_CTL2      (ANA_REG_BASE + 0x58)
#define   ANA_LDO_SLP_CTL3      (ANA_REG_BASE + 0x5c)
#define   ANA_LDO_DP_SLP_CTL0   (ANA_REG_BASE + 0x60)
#define   ANA_LDO_DP_SLP_CTL1   (ANA_REG_BASE + 0x64)
#define   ANA_LDO_XTL_SLP_CTL0  (ANA_REG_BASE + 0x68)
#define   ANA_LDO_XTL_SLP_CTL1  (ANA_REG_BASE + 0x6c)
#define   ANA_SLP_LP_CTL0       (ANA_REG_BASE + 0x70)
#define   ANA_SLP_LP_CTL1       (ANA_REG_BASE + 0x74)
#define   ANA_SLP_LP_XTL_CTL0   (ANA_REG_BASE + 0x78)
#define   ANA_SLP_LP_XTL_CTL1   (ANA_REG_BASE + 0x7C)
#define   ANA_LDO_SLP_CTL       (ANA_REG_BASE + 0x80)
#define   ANA_AUDIO_CTL         (ANA_REG_BASE + 0x88)
#define   ANA_CHGR_CTL0         (ANA_REG_BASE + 0x8C)
#define   ANA_CHGR_CTL1         (ANA_REG_BASE + 0x90)
#define   ANA_VIBRATOR_CTL0     (ANA_REG_BASE + 0x94)
#define   ANA_VIBRATOR_CTL1     (ANA_REG_BASE + 0x98)
#define   ANA_VIBRATOR_CTL2     (ANA_REG_BASE + 0x9c)
#define   ANA_VIBR_WR_PROT      (ANA_REG_BASE + 0xa0)
#define   ANA_MCU_WR_PROT       (ANA_REG_BASE + 0xa4)
#define   ANA_MUC_WR_STS        (ANA_REG_BASE + 0xa8)
#define   ANA_RTC_CTRL          (ANA_REG_BASE + 0xac)
#define   ANA_RTC32K_OSC_EN     (ANA_REG_BASE + 0xb0)
#define   ANA_KPLED_CTRL        (ANA_REG_BASE + 0xb4)
#define   ANA_XTL_WAIT          (ANA_REG_BASE + 0xb8)
#define   ANA_MIXED_CTRL        (ANA_REG_BASE + 0xbc)
#define   ANA_STS               (ANA_REG_BASE + 0xc0)
#define   ANA_WDG_HRST_STS      (ANA_REG_BASE + 0xc4)
#define   ANA_HWRST_STATUS      (ANA_REG_BASE + 0xc8)
#define   ANA_ALL_HRST_STS      (ANA_REG_BASE + 0xcc)
#define   ANA_INT_GPI_DBG       (ANA_REG_BASE + 0xd0)
#define   ANA_HWRST_RTC         (ANA_REG_BASE + 0xd4)
#define   ANA_IF_SPR_CTL        (ANA_REG_BASE + 0xd8)
#define   ANA_AFUSE_CTL         (ANA_REG_BASE + 0xe0)
#define   ANA_AFUSE_OUT0        (ANA_REG_BASE + 0xe4)
#define   ANA_AFUSE_OUT1        (ANA_REG_BASE + 0xe8)
#define   ANA_AFUSE_OUT2        (ANA_REG_BASE + 0xec)
#define   ANA_AFUSE_OUT3        (ANA_REG_BASE + 0xf0)
#define   ANA_EXT_FLAG_CTL      (ANA_REG_BASE + 0xf4)
#define   ANA_POR_SRC_FLAG      (ANA_REG_BASE + 0xf8)
#define   ANA_PBINT_7S_CTL      (ANA_REG_BASE + 0xfc)
#define   ANA_DCDC_CORE_CTRL0   (ANA_REG_BASE + 0x100)
#define   ANA_DCDC_CORE_CTRL1   (ANA_REG_BASE + 0x104)
#define   ANA_DCDC_CORE_CTRL2   (ANA_REG_BASE + 0x108)
#define   ANA_DCDC_CORE_CTRL3   (ANA_REG_BASE + 0x10c)
#define   ANA_DCDC_OPT_CTL      (ANA_REG_BASE + 0x114)
#define   ANA_DCDC_ARM_CTL      (ANA_REG_BASE + 0x118)
#define   ANA_DCDC_ARM_CTL      (ANA_REG_BASE + 0x11c)
#define   ANA_DCDC_ARM_CTL      (ANA_REG_BASE + 0x120)
#define   ANA_DCDC_ARM_CTL      (ANA_REG_BASE + 0x124)
#define   ANA_DCDC_MEM_CTL0     (ANA_REG_BASE + 0x12c)
#define   ANA_DCDC_MEM_CTL1     (ANA_REG_BASE + 0x130)
#define   ANA_DCDC_MEM_CTL2     (ANA_REG_BASE + 0x134)
#define   ANA_DCDC_MEM_CTL3     (ANA_REG_BASE + 0x138)
#define   ANA_WPA_DCDC_AP_CTL0  (ANA_REG_BASE + 0x140)
#define   ANA_WPA_DCDC_AP_CTL1  (ANA_REG_BASE + 0x144)
#define   ANA_WPA_DCDC_AP_CTL2  (ANA_REG_BASE + 0x148)
#define   ANA_DCDC_LP_EN        (ANA_REG_BASE + 0x14c)
#define   ANA_DCDC_SLP_V        (ANA_REG_BASE + 0x150)
#define   ANA_LDO_TRIM0         (ANA_REG_BASE + 0x154)
#define   ANA_LDO_TRIM1         (ANA_REG_BASE + 0x158)
#define   ANA_LDO_TRIM2         (ANA_REG_BASE + 0x15c)
#define   ANA_LDO_TRIM3         (ANA_REG_BASE + 0x160)
#define   ANA_LDO_TRIM4         (ANA_REG_BASE + 0x164)
#define   ANA_LDO_TRIM5         (ANA_REG_BASE + 0x168)
#define   ANA_LDO_TRIM6         (ANA_REG_BASE + 0x16c)
#define   ANA_LDO_TRIM7         (ANA_REG_BASE + 0x170)
#define   ANA_LDO_TRIM8         (ANA_REG_BASE + 0x174)
#define   ANA_LDO_TRIM9         (ANA_REG_BASE + 0x178)
#define   ANA_LDO_CAL           (ANA_REG_BASE + 0x17c)
#define   ANA_LDO_SWITCH        (ANA_REG_BASE + 0x180)
#define   ANA_WHTLED_CTL0       (ANA_REG_BASE + 0x188)
#define   ANA_WHTLED_CTL1       (ANA_REG_BASE + 0x18c)
#define   ANA_WHTLED_CTL2       (ANA_REG_BASE + 0x190)
#define   ANA_WHTLED_CTL3       (ANA_REG_BASE + 0x194)
...
///ANA_LDO_PD_SET
#define ANA_LDO_PD_SET_MSK  0x1fff
///ANA_LDO_PD_CTL
