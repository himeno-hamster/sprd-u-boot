...
#define   ANA_LDO_SLP_CTL0      (ANA_REG_BASE + 0x30)
#define   ANA_LDO_SLP_CTL1      (ANA_REG_BASE + 0x34)
#define   ANA_LDO_SLP_CTL2      (ANA_REG_BASE + 0x38)
#define   ANA_LDO_SLP_CTL3      (ANA_REG_BASE + 0x3C)
#define   ANA_DCDC_CTL0          (ANA_REG_BASE + 0x40)
#define   ANA_DCDC_CTL1          (ANA_REG_BASE + 0x44)
#define   ANA_DCDC_CTL2          (ANA_REG_BASE + 0x48)
#define   ANA_DCDC_CTL_DS       (ANA_REG_BASE + 0x4C)
#define   ANA_DCDC_CTL_CAL      (ANA_REG_BASE + 0x50)
#define   ANA_PLL_CTL           (ANA_REG_BASE + 0x54)
#define   ANA_APLLMN            (ANA_REG_BASE + 0x58)
#define   ANA_APLLWAIT          (ANA_REG_BASE + 0x5C)
#define   ANA_RTC_CTL           (ANA_REG_BASE + 0x60)
#define   ANA_TRF_CTL           (ANA_REG_BASE + 0x64)
#define   ANA_CHGR_CTL0         (ANA_REG_BASE + 0x68)
#define   ANA_CHGR_CTL1         (ANA_REG_BASE + 0x6C)
#define   ANA_LED_CTL           (ANA_REG_BASE + 0x70)
#define   ANA_VIBRATOR_CTL0     (ANA_REG_BASE + 0x74)
#define   ANA_VIBRATOR_CTL1     (ANA_REG_BASE + 0x78)
#define   ANA_AUDIO_CTL         (ANA_REG_BASE + 0x7C)
