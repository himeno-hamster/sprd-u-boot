...
#define INTER_RAM_BEGIN                 0x00020000    //Internal ram
#define INTER_RAM_END                   0x0002A7FF    //The address of the last byte
...
#define INT_CTL_BEGIN                   0x40003000    //Interrupt Control Registers                 
#define INT_CTL_END                     0x40000040    //the begin address of the last word

#define TIMER_CNT_BEGIN                 0x41000000    //tiemr counter Registers
#define TIMER_CNT_END                   0x4100004C    //the begin address of the last word

#define ADI_CTL_BEGAIN                  0x42000000  //adi master control registers
#define ADI_CTL_END                     0x42000034

#define UART0_CTL_BEGIN                 0x43000000    //UART0,SPI0 Control Registers
#define UART0_CTL_END                   0x4300002C    //the begin address of the last word

#define UART1_CTL_BEGIN                 0x44000000    //UART1,SPI1 Control Registers
#define UART1_CTL_END                   0x4400002C    //the begin address of the last word

#define UART2_CTL_BEGIN                 0x4E000000    //UART2,SPI2 Control Registers
#define UART2_CTL_END                   0x4E00002C    //the begin address of the last word
...
#define SYS_CNT_BEGIN                   0x47003000    //system counter Registers
#define SYS_CNT_END                     0x47003008    //the begin address of the last word
...
#define GLOBAL_CTL_BEGIN                0x4B000000    //GLOBAL Control Registers
#define GLOBAL_CTL_END                  0x4B000080    //the begin address of the last word
...
#define TIMER_CTL_BASE                  0x41000000  //Timer0 (RTC)
#define ADI_BASE                        0x42000000  //ADI master
#define WDG_BASE                        0x42000040  //Analog die register   
#define RTC_BASE                        0x42000080
#define ANA_DOLPHIN_BASE                0x42000100  //Analog die register   
#define ANA_PINMAP_BASE                 0x42000180
#define TPC_BASE                        0x42000280
#define ADC_BASE                        0x42000300
#define ANA_INTC_BASE                   0x42000380
#define ANA_REG_BASE                    0x42000600
#define ANA_GPIO_BASE                   0x42000600
#define ARM_VBC_BASE                    0x42003000
#define ARM_UART0_BASE                  0x43000000
#define ARM_UART1_BASE                  0x44000000
#define ARM_UART2_BASE                  0x4E000000
#define SIM0_BASE                       0x45000000  //SIM0
#define SIM1_BASE                       0x45003000  //SIM1
#define I2C_BASE                        0x46000000
#define KPD_BASE                        0x47000000
#define SYSTIMER_BASE                   0x47003000  //System timer
...
#define EPT_BASE                        0x4D000000
#define PCM_CTL_BASE                    0x4E001000
#define SPI_BASE                        0x4E002000
...
#define SDIO2_BASE_ADDR                 0x20E00000
#ifdef CONFIG_EMMC_BOOT
#define EMMC_BASE_ADDR                  0x20F00000
#else
