...
#define ANA_REGS_GLB_PHYS  	( ANA_CTL_GLB_BASE )
...
#define SPRD_ANA_ADC_PHYS	ANA_ADC_BASE
#define SPRD_ANA_RTC_PHYS	ANA_RTC_BASE
#define SPRD_ANA_GPIO_PHYS	ANA_GPIO_INT_BASE
#define SPRD_ANA_WDG_BASE	ANA_WDG_BASE
...
#define REGS_ANA_APB_IF_BASE 	ANA_CTL_GLB_BASE
