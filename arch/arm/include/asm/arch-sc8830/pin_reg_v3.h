...
#define PIN_CTL0_REG                            REG_ADDR(0x0000)
#define PIN_CTL1_REG                            REG_ADDR(0x0004)
#define PIN_CTL2_REG                            REG_ADDR(0x0008)
#define PIN_CTL3_REG                            REG_ADDR(0x000C)
#define PIN_CTL4_REG                            REG_ADDR(0x0010)
#define PIN_CTL5_REG                            REG_ADDR(0x0014)
...
#define PIN_SD0_CLK_REG                         REG_ADDR(0x0030)
#define PIN_SD0_CMD_REG                         REG_ADDR(0x0034)
#define PIN_SD0_D0_REG                          REG_ADDR(0x0038)
#define PIN_SD0_D1_REG                          REG_ADDR(0x003c)
#define PIN_SD0_D2_REG                          REG_ADDR(0x0040)
#define PIN_SD0_D3_REG                          REG_ADDR(0x0044)
#define PIN_SD1_CLK_REG                         REG_ADDR(0x01fc)
#define PIN_SD1_CMD_REG                         REG_ADDR(0x0200)
#define PIN_SD1_D0_REG                          REG_ADDR(0x0204)
#define PIN_SD1_D1_REG                          REG_ADDR(0x0208)
#define PIN_SD1_D2_REG                          REG_ADDR(0x020c)
#define PIN_SD1_D3_REG                          REG_ADDR(0x0210)
...
#define PIN_NFWPN_REG                          REG_ADDR(0x0174)
#define PIN_NFRB_REG                           REG_ADDR(0x0178)
#define PIN_NFCLE_REG                          REG_ADDR(0x017C)
#define PIN_NFALE_REG                          REG_ADDR(0x0180)
#define PIN_NFCEN_REG                          REG_ADDR(0x0184)
#define PIN_NFWEN_REG                          REG_ADDR(0x0188)
#define PIN_NFREN_REG                          REG_ADDR(0x018C)
#define PIN_NFD0_REG                           REG_ADDR(0x0190)
#define PIN_NFD1_REG                           REG_ADDR(0x0194)
#define PIN_NFD2_REG                           REG_ADDR(0x0198)
#define PIN_NFD3_REG                           REG_ADDR(0x019C)
#define PIN_NFD4_REG                           REG_ADDR(0x01A0)
#define PIN_NFD5_REG                           REG_ADDR(0x01A4)
#define PIN_NFD6_REG                           REG_ADDR(0x01A8)
#define PIN_NFD7_REG                           REG_ADDR(0x01AC)
#define PIN_NFD8_REG                           REG_ADDR(0x01B0)
#define PIN_NFD9_REG                           REG_ADDR(0x01B4)
#define PIN_NFD10_REG                          REG_ADDR(0x01B8)
#define PIN_NFD11_REG                          REG_ADDR(0x01BC)
#define PIN_NFD12_REG                          REG_ADDR(0x01C0)
#define PIN_NFD13_REG                          REG_ADDR(0x01C4)
#define PIN_NFD14_REG                          REG_ADDR(0x01C8)
#define PIN_NFD15_REG                          REG_ADDR(0x01CC)
#define PIN_SD3CLK_REG                         REG_ADDR(0x01D0)
#define PIN_SD3CMD_REG                         REG_ADDR(0x01D4)
#define PIN_SD3D0_REG                          REG_ADDR(0x01D8)
#define PIN_SD3D1_REG                          REG_ADDR(0x01DC)
#define PIN_SD3D2_REG                          REG_ADDR(0x01E0)
#define PIN_SD3D3_REG                          REG_ADDR(0x01E4)
#define PIN_SD3D4_REG                          REG_ADDR(0x01E8)
#define PIN_SD3D5_REG                          REG_ADDR(0x01EC)
#define PIN_SD3D6_REG                          REG_ADDR(0x01F0)
#define PIN_SD3D7_REG                          REG_ADDR(0x01F4)
