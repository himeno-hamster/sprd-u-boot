...
static pinmap_t  pinmap[] = {
      ...
      {REG_PIN_SD0_D3,              BIT_PIN_NULL|BITS_PIN_DS(4)|BITS_PIN_AF(0)|BIT_PIN_WPU|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},
      {REG_PIN_SD0_D2,              BIT_PIN_NULL|BITS_PIN_DS(4)|BITS_PIN_AF(0)|BIT_PIN_WPU|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},
      {REG_PIN_SD0_CMD,             BIT_PIN_NULL|BITS_PIN_DS(4)|BITS_PIN_AF(0)|BIT_PIN_WPU|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},
      {REG_PIN_SD0_D0,              BIT_PIN_NULL|BITS_PIN_DS(4)|BITS_PIN_AF(0)|BIT_PIN_WPU|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},
      {REG_PIN_SD0_D1,              BIT_PIN_NULL|BITS_PIN_DS(4)|BITS_PIN_AF(0)|BIT_PIN_WPU|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},
      {REG_PIN_SD0_CLK1,            BIT_PIN_NULL|BITS_PIN_DS(1)|BITS_PIN_AF(0)|BIT_PIN_WPD|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},
      {REG_PIN_SD0_CLK0,            BIT_PIN_NULL|BITS_PIN_DS(5)|BITS_PIN_AF(0)|BIT_PIN_NUL|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},
