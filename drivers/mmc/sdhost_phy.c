...
#define REG_PIN_EMMC_D7      REG_PIN_NFALE
			...
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_CMD)= 0x190;
			REG32(CTL_PIN_BASE+REG_PIN_NFD10)   = 0x190;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D0) = 0x190;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D1) = 0x190;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D2) = 0x190;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D3) = 0x190;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D4) = 0x190;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D5) = 0x190;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D6) = 0x190;
			REG32(CTL_PIN_BASE+REG_PIN_EMMC_D7) = 0x190;
#else
