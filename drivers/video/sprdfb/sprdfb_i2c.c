...
static int32_t sprdfb_i2c_write_8bits(uint8 addr, uint8_t reg, uint8_t val)
{
	uint8_t buf_w[2];
	uint32_t i = 0;
	int32_t ret = -1;
...
static int32_t sprdfb_i2c_read_8bits(uint8 addr, uint8_t reg, uint8_t *val)
{
	uint32_t i;
	int32_t ret = -1;
...
static int32_t sprdfb_i2c_write_16bits(uint8 addr, uint16_t reg, BOOLEAN reg_is_8bit, uint16_t val, BOOLEAN val_is_8bit)
{
	uint8_t cmd[4] = { 0 };
	uint32_t i = 0;
	uint32_t cmd_num = 0;
...
static int32_t sprdfb_i2c_read_16bits(uint8 addr, uint16_t reg, BOOLEAN reg_is_8bit, uint16_t *val, BOOLEAN val_is_8bit)
{
	uint32_t i = 0;
	uint8_t cmd[2] = { 0 };
...
static int32_t sprdfb_i2c_write_burst(uint8 addr, uint8_t* buf, int num)
{
	uint32_t i = 0;
	int32_t ret = -1;
