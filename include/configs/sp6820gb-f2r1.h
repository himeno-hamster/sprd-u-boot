...
#define MTDPARTS_DEFAULT "mtdparts=sprd-nand:256k(spl),512k(2ndbl),256k(params),256k(vmjaluna),4m(modem),2816k(fixnv),2816k(backupfixnv),2048k(dsp),2816k(runtimenv),8m(boot),8m(recovery),100m(system),87m(userdata),20m(cache),256k(misc),1m(boot_logo),1m(fastboot_logo),2816k(productinfo),512k(kpanic),512k(simlock),10m(intmemory)"
