...
#define MTDPARTS_DEFAULT "mtdparts=sprd-nand:256k(spl),768k(2ndbl),256k(params),512k(vmjaluna),6m(modem),2816k(fixnv),2816k(backupfixnv),4m(dsp),3840k(runtimenv),6m(boot),6m(recovery),110m(system),87m(userdata),7m(cache),256k(misc),512k(boot_logo),512k(fastboot_logo),2816k(productinfo),512k(kpanic),512k(simlock),10m(intmemory)"
