...
#define MTDPARTS_DEFAULT "mtdparts=sprd-nand:256k(spl),768k(2ndbl),256k(params),512k(vmjaluna),6m(modem),2816k(fixnv),2816k(backupfixnv),4m(dsp),3840k(runtimenv),8m(boot),6m(recovery),108m(system),97m(userdata),7m(cache),256k(misc),512k(boot_logo),512k(fastboot_logo),2816k(productinfo),512k(kpanic),512k(simlock)"
