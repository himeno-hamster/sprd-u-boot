...
/*2013-09-25, to add logger buffer dynamic-enable-action option*/
...
#define CONFIG_BOOTARGS "mem=64M console=ttyS1,115200n8 init=/init "MTDPARTS_DEFAULT CONFIG_KERNEL_USRDEBUG
...
#define CONFIG_BOOTARGS "mem=240M console=ttyS1,115200n8 init=/init " MTDPARTS_DEFAULT CONFIG_KERNEL_USRDEBUG
#endif
