...
#define SIPC_APCP_RESET_ADDR_SIZE	0x1000	/*4K*/
#define SIPC_TD_APCP_START_ADDR		(PHYS_OFFSET_ADDR + TD_CP_OFFSET_ADDR + TD_CP_SDRAM_SIZE - SIPC_APCP_RESET_ADDR_SIZE)	/*0x897FF000*/
#define SIPC_WCDMA_APCP_START_ADDR	(PHYS_OFFSET_ADDR + WCDMA_CP_OFFSET_ADDR + WCDMA_CP_SDRAM_SIZE - SIPC_APCP_RESET_ADDR_SIZE) /*0x93FFF000*/
