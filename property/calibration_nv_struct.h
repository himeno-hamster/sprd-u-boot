...
//struct  calibration_struct_va
//{
#define NUM_TEMP_BANDS  5
//constant parameter numbers, 16 level
#define NUM_RAMP_RANGES  16
 // 2db per step
#define NUM_TX_LEVEL  16
...
//}calibration_struct_va_T;
//xu gao
#define OFFSET (sizeof(RF_ramp_table_T) + sizeof(RF_aero2_AFC_T) + sizeof(RF_aero1_AFC_T) + sizeof(RF_param_common_DSP_use_T) + sizeof(RF_param_band_DSP_use_T) + sizeof(RF_param_DSP_use_T) + sizeof(RF_param_MCU_use_T) + sizeof(Misc_cal_MCU_use_T))


////////////////////////////////////////////////////////////////////////////////
// For TD Calibration
//struct td_calibration_struct_v3
//{

#define AGC_GAIN_LEN_QS3200	 1495
#define AGC_CTL_LEN_QS3200	 115
#define APC_CTL_LEN_QS3200	 1300
...
#define APC_COMP_LEN_QS3200	 613
    ...
    }td_calibration_T_v3; //TD_QS3200_CALI_DATA;

//}

//struct td_calibration_struct_v4
//{

#define AGC_GAIN_LEN_QS3200	 2875
#define APC_CTL_LEN_QS3200	 2500
    typedef struct
    {
           uint16   cali_version;
           uint16   rf_afc_dac;
    ...
    }td_calibration_T_v4; //TD_QS3200_CALI_DATA; 8800G

//}

//////////////////////////////////////////////////////////////////////////
// LTE Calibration
//struct lte_calibration_struct_v1
//{
